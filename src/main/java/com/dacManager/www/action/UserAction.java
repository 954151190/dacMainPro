...
public class UserAction extends ActionSupport {  
    ...
    public String userList() {
    	...
    	contextMap.put(StaticVariable.PAGE_USER, this.page);//设置分页属性
    	userList = userService.selectUserList4Page(contextMap);
    	//处理分页对象
    	//查询总数
    	Long allEntry = userService.countEntry( contextMap );
