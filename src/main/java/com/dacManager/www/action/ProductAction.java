...
public class ProductAction extends ActionSupport {  
    ...
    public String productList() {
    	...
    	contextMap.put(StaticVariable.PAGE_PRODUCT, this.page);//设置分页属性
    	productList = productServer.selectEntryList4Page(contextMap);
    	//处理分页对象
    	//查询总数
    	Long allEntry = productServer.countEntry( contextMap );
