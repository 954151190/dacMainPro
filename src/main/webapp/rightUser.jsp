...
<script>
	...
	function pageGo() {
		...
		if( isNaN(goNumber) ||  goNumber <= 0 || goNumber > allPage ) {
			...
			window.location.href="toUserList?page.number="+goNumber+"&page.count="+count+"";			
		}
	}
	...
	function goLastPage() {
		window.location.href="toUserList?page.number=1&page.count="+count+"";
	}
	
	function goNextPage() {
		window.location.href="toUserList?page.number="+allPage+"&page.count="+count+"";
	}
</script>
</html>
