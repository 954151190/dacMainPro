...
<script>
	...
	function pageGo() {
		...
		if( isNaN(goNumber) ||  goNumber <= 0 || goNumber > allPage ) {
			...
			window.location.href="toProductList?page.number="+goNumber+"&page.count="+count+"";			
		}
	}
	...
	function goLastPage() {
		window.location.href="toProductList?page.number=1&page.count="+count+"";
	}
	
	function goNextPage() {
		window.location.href="toProductList?page.number="+allPage+"&page.count="+count+"";
	}
</script>
</html>