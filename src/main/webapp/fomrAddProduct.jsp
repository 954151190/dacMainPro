    ...
    <div class="formbody">
	    ...
	    <form action="productAdd" method="post" id="productAdd"  name="productAdd"   enctype="multipart/form-data">
		    <ul class="forminfo">
			    ...
			    <li><input type="hidden" id="product.title" name="product.title" value="" /></li>
			    <li><input type="hidden" id="product.content" name="product.content" value="" /></li>
				<li><label>&nbsp;</label><input name="" type="submit" class="btn" value="确认保存" onclick="javascript:SaveProduct()"/></li>
		    </ul>
	    </form>
    </div>
    <div>
